...
class RsaKeyHelper {
  ...
  getEncrypter(String publicKey, String privateKey) {
    final RSAPrivateKey rsaPrivateKey = parsePrivateKeyFromPem(privateKey);
    final RSAPublicKey rsaPublicKey = parsePublicKeyFromPem(publicKey);
    final encrypts = rsa.Encrypter(
        rsa.RSA(publicKey: rsaPublicKey, privateKey: rsaPrivateKey));
    return encrypts;
  }
}
